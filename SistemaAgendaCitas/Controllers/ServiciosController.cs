...
namespace SistemaAgendaCitas.Controllers
{
    public class ServiciosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Descripcion,Duracion,Precio,Activo")] Servicio servicio)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Descripcion,Duracion,Precio,Activo")] Servicio servicio)
        {
            if (id != servicio.Id)
            {
                return NotFound();
